...
class AboutUsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // FIX: Using Scaffold to define the screen structure and wrapping the body
    // content in a SingleChildScrollView to eliminate overflow errors.
  ...
  Widget _buildTimelineItem(String date, String description, String assetPath) {
    return Padding(
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ), // FIX: Added comma here to separate list items
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(
                12,
              ), // Slightly smaller radius for sleek look
              boxShadow: [
                BoxShadow(
                  color: Colors.black.withOpacity(0.05),
                  blurRadius: 10,
