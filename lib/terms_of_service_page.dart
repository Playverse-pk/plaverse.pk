...
// import 'package:playverse/nav_item.dart'; // No longer needed
import 'package:playverse/playverse_app_bar.dart'; // Import the custom App Bar

class TermsOfServicePage extends StatelessWidget {
  const TermsOfServicePage({super.key});

  // Helper function to build a list item (for the terms sections)
  ...
  // Removed unused goHome helper, as navigation is handled by the AppBar
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // 🔹 Footer (Set isTermsPage to true to disable the Terms link in the footer)
